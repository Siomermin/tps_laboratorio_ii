...
namespace Entidades
{
    public class Cliente
    {
        ...
        {
            if (dniStr.ValidarDni(out int dni) && nombreStr.ValidarString(out string nombre) && apellidoStr.ValidarString(out string apellido) && edad >= 11 && edad <= 125 && planGimnasio >= 0 && planGimnasio <= 2)
            {

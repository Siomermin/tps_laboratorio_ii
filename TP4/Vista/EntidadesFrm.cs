...
namespace Vista
{
    ...
    {
        public delegate void DelegadoEntrenamiento();
        ...
        public async static void ActualizarDGV(DataGridView dgv)
        {
            try
            {
                Gimnasio.ListaClientes = await ClienteDAO.LeerClientesAsync();
                dgv.DataSource = null;
